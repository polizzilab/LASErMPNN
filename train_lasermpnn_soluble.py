...
from LASErMPNN.utils.pdb_dataset import UnclusteredProteinChainDataset, SolubleDatasetSampler, collate_sampler_data, BatchData, invert_dict, chain_list_to_protein_chain_dict
...
def prepare_dataloaders(rank, world_size, params, epoch_num, dataset, collate_fn, test_only=False):
    ...
    test_sampler = SolubleDatasetSampler(dataset, params, is_train=False, seed=seed, max_protein_length=params['max_protein_size'])
    ...
    train_sampler = SolubleDatasetSampler(dataset, params, is_train=True, seed=seed, max_protein_length=params['max_protein_size'])
...
if __name__ == "__main__":
    ...
    ALTERNATE_DATABASE_PATH = Path('/home/nickhedu/programs/LASErMPNN/')
    params = {
        'debug': (debug := False),
        ...
        'output_weights_checkpoint_prefix': CURR_FILE_DIR_PATH / 'model_weights/soluble_weights_no_heldout_drop_clusters',
